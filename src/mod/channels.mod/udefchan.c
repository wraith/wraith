static int
expmem_udef (struct udef_struct *ul)
{
  int i = 0;
  for (; ul; ul = ul->next)
    {
...
static int
expmem_udef_chans (struct udef_chans *ul)
{
  int i = 0;
  for (; ul; ul = ul->next)
    {
...
static int
getudef (struct udef_chans *ul, char *name)
{
  int val = 0;
  for (; ul; ul = ul->next)
...
static void
setudef (struct udef_struct *us, char *name, int value)
{
...
static void
initudef (int type, char *name, int defined)
{
...
static void
free_udef (struct udef_struct *ul)
{
...
static void
free_udef_chans (struct udef_chans *ul)
{
