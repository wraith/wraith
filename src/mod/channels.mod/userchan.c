...
capslimit %d colorlimit %d closed-ban %d closed-invite %d closed-private %d closed-exempt %d \
ban-time %d exempt-time %d invite-time %d voice-non-ident %d auto-delay %d \
