...
int botnet_send_cmd (char *fbot, char *bot, char *from, int fromidx,
		     char *cmd);
void botnet_send_cmd_broad (int idx, char *fbot, char *from, int fromidx,
			    char *cmd);
void botnet_send_cmdreply (char *fbot, char *bot, char *to, char *toidx,
			   char *ln);
#endif
