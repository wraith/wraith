...
struct user_entry_type
{
  ...
  int (*tcl_get) (Tcl_Interp *, struct userrec *, struct user_entry *, int,
		  char **);
  int (*tcl_set) (Tcl_Interp *, struct userrec *, struct user_entry *, int,
		  char **);
...
struct user_entry *find_user_entry (struct user_entry_type *,
				    struct userrec *);
...
int def_gotshare (struct userrec *u, struct user_entry *e, char *data,
		  int idx);
